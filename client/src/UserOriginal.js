...
function UserOriginal({ loggedIn }) {
  ...
  return (
    <>
      ...
      >
        <h1 style={{ fontFamily: "Roboto, sans-serif", fontWeight: "1000" }}>
          Add Your Recipe
        </h1>
        <TextField
        ...
        <form>
          <p style={{ fontFamily: "Robot, sans-serif" }}>
            {" "}
            {id
              ? "Would you like to change the photo?"
        ...
        {id ? (
          <div>
            {" "}
            <Button
              style={{ marginTop: "12px", fontFamily: "Robot, sans-serif" }}
              variant="contained"
              onClick={handleRecipePatch}
            >
              SAVE CHANGES
            </Button>{" "}
            <Button
